        ...
        <section className="space-y-5">
          ...
          <section className="space-y-4">
            <div>
              ...
              <p className="text-sm text-muted">Resultatene under er midlertidige søkeresultater. Trykk Legg i basisutvalg for å lagre riktig variant og alle butikkprisene som vises.</p>
            </div>
